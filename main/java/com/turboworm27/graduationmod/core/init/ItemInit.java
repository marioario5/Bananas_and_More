...
public class ItemInit {
	...
	public static final RegistryObject<Item> PERFECT_BANANA_PEEL = ITEMS.register("perfect_banana_peel",() -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP)));
	public static final RegistryObject<Item> GREEN_BANANA_PEEL = ITEMS.register("green_banana_peel",() -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP)));
	public static final RegistryObject<Item> YELLOW_BANANA_PEEL = ITEMS.register("yellow_banana_peel",() -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP)));
	public static final RegistryObject<Item> ROTTEN_BANANA_PEEL = ITEMS.register("rotten_banana_peel",() -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP)));
	public static final RegistryObject<Item> GREEN_BROWN_BANANA_PEEL = ITEMS.register("green_brown_banana_peel",() -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP)));
	public static final RegistryObject<Item> HEART_OF_BANANA = ITEMS.register("heart_of_banana", () -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP)));
	
	//food items
	public static final RegistryObject<Item> PERFECT_BANANA = ITEMS.register("perfect_banana", () -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP).food(FoodInit.PERFECT_BANANA)));
	public static final RegistryObject<Item> GREEN_BANANA = ITEMS.register("green_banana", () -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP).food(FoodInit.GREEN_BANANA)));
	public static final RegistryObject<Item> YELLOW_BANANA = ITEMS.register("yellow_banana", () -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP).food(FoodInit.YELLOW_BANANA)));
	public static final RegistryObject<Item> ROTTEN_BANANA = ITEMS.register("rotten_banana", () -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP).food(FoodInit.ROTTEN_BANANA)));
	public static final RegistryObject<Item> GREEN_BROWN_BANANA = ITEMS.register("green_brown_banana", () -> new Item(new Item.Properties().group(GraduationMod.BANANAGROUP).food(FoodInit.GREEN_BROWN_BANANA)));
	...
	public static final RegistryObject<BlockItem> BANANA_ORE = ITEMS.register("banana_ore", () -> new BlockItem(BlockInit.BANANA_ORE.get(), new Item.Properties().group(GraduationMod.BANANAGROUP)));
	public static final RegistryObject<BlockItem> PERFECT_BANANA_BLOCK = ITEMS.register("perfect_banana_block", () -> new BlockItem(BlockInit.PERFECT_BANANA_BLOCK.get(), new Item.Properties().group(GraduationMod.BANANAGROUP)));
